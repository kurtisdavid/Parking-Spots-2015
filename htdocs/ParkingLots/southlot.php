...
<div id="layout">
    ...
    <div id="main">
        ...
        <div class="content">
            ...
            <form class="pure-form pure-form-stacked" action="south.php" method="POST">
                <fieldset>
                ...
                <fieldset>
                    ...
                    <label for="text">Student 1 Name</label>
                    <input id="text" type="text" name="student_name1" placeholder="First Name Last Name">

                    <label for="number">Student 1 ID</label>
                    <input id="number" type="number" name="student_ID1" placeholder="Student ID">
                    ...
                    <p></p>
                    <label for="text">Student 2 Name</label>
                    <input id="text" type="text" name="student_name2" placeholder="First Name Last Name">

                    <label for="number">Student 2 ID</label>
                    <input id="number" type="number" name="student_ID2" placeholder="Student ID">
           ...
           <p></p>
            ...
            <form class="pure-form" action="searchsouth.php" method="POST">
                <fieldset>
